...
const swapArrival:Shape={id:'string',fleetId:'string',atMinute:'number',returnSOC:nullable('number'),unitPrice:nullable('number'),returnedPack:nullable(battery),requestedKWh:optional(nullable('number')),minReturnSOC:optional(nullable('number'))};
