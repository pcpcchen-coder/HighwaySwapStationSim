...
async function main() {
  ...
  const codeFiles=['packages/contracts/index.ts','packages/station-engine/index.ts','packages/electrical-engine/index.ts','packages/money/index.ts','packages/verification/cases.ts','plugins/equipment/index.ts','data/verification/fixtures.json'];
