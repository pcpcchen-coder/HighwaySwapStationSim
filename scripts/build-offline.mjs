...
const output=path.resolve(process.argv[2]??path.join(project,'outputs/HighwaySwapSim-0.8.0-offline.html'));
...
const html=`<!doctype html><html lang="zh-Hant"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="highwayswapsim-source" content="${sha}"><meta name="highwayswapsim-offline-build" content="2026-09-18-single-bus"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; script-src 'unsafe-inline'; style-src 'unsafe-inline'; worker-src blob:; img-src data: blob:; font-src data:; connect-src 'none'; object-src 'none'; base-uri 'none'"><title>HighwaySwapSim 0.8.0 · 單檔離線版（單母線第一期）</title><link rel="icon" href="data:,"><style>${css}</style></head><body class="antialiased"><aside style="padding:8px 24px;background:#e8f3ff;color:#123757;font:14px system-ui">單檔離線版 · ENGINE 0.8.0 · 單母線第一期 2026-09-18 · 修改後請匯出 JSON 保存；結果 XLSX 保存上次測算快照。工程文件連結需連網。</aside><div id="root"><p style="padding:24px">正在載入測算介面…</p></div><noscript>請啟用瀏覽器 JavaScript 以執行測算。</noscript><script>${escapeScript(startup+js)}</script></body></html>`;
